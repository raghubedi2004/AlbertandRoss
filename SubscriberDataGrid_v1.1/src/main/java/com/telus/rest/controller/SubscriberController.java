...
public class SubscriberController {
    ...
    @RequestMapping(method=RequestMethod.GET, value="/retrieveBANSubscribers")
    public List<SubscriberInfo> retrieveBANSubscribers(@RequestParam(value="ban") String ban) {
    	
		MongoClient mongoClient = new MongoClient();
		
		MongoDBSubscriberDAO subscriberDAO = new MongoDBSubscriberDAO(mongoClient);
		
		List<SubscriberInfo> subscribers = subscriberDAO.readBANSubscriberInfos(Integer.valueOf(ban));
