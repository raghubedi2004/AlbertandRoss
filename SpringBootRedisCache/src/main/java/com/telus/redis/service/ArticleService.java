...
import com.telus.redis.repository.ArticleRepository;

@Service
@CacheConfig(cacheNames = "allArticlesCache", keyGenerator= "myKeyGen")	
public class ArticleService implements IArticleService {
	...
	@Override
	@Cacheable
	//@Cacheable(value= "allArticlesCache", unless= "#result.size() == 0", keyGenerator= "allArticles")	
