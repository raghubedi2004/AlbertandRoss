...
public class ResponsePayloadVO implements Serializable {
	...
	public ResponsePayloadVO(String ban, String sub, String plan, String equipmentTypeCd, String role, String language) {
		super();
		this.ban = ban;
		this.sub = sub;
		this.plan = plan;
